...
echo Smart Tools functions will be limited without an internet connection.
echo Please connect to the internet to get the complete experience from the app.
echo The program will start itself in recovery mode.
echo Only offline operations will be avaiable.
echo The program will start in 30 seconds.

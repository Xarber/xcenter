...
chdir "%userprofile%\OneDrive\Desktop\Productivity\X-CenterDB"
goto datamode
:datamode
cls
...
start "weblink" "https://github.com/Xarber/xcenterdb/tree/release/smart-tools/"
exit
:auto
cls
git init

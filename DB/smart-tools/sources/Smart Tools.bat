...
::cRYluBh/LU+EWAnk
::YxY4rhs+aU+IeA==
::cxY6rQJ7JhzQF1fEqQJheFUDAlTMbQs=
::ZQ05rAF9IBncCkqN+0xwdVsFHErVcjv0V9U=
::ZQ05rAF9IAHYFVzEqQIDJRpGWES2M2S2FdU=
::eg0/rx1wNQPfEVWB+kM9LVsJDDePPXmuRpwS+/z64+aCsC0=
::fBEirQZwNQPfEVWB+kM9LVsJDByROX+vFtU=
::cRolqwZ3JBvQF1fEqQIZJghATQiOfEiyFLoR7ajU3Kq3rlgaXewsOIDJmqabLqAG+UDiYJptwnVVlNhMChRKPgukex10mU0D1g==
::dhA7uBVwLU+EWGHJ10c+PB5GLA==
::YQ03rBFzNR3SWATEuSI=
::dhAmsQZ3MwfNWATEphJieVtsTRaAOXna
::ZQ0/vhVqMQ3MEVWAtB9weUsaG0rScjra
::Zg8zqx1/OA3MEVWAtB9weUsaG0rScjra
...
if not exist "%cd%\Settings\Options.data" (
::AUTHKEY
echo %authkey%>"%cd%\Settings\Options.data"
::PASS
echo Not Set>>"%cd%\Settings\Options.data"
::PASSLOCK
echo Disabled>>"%cd%\Settings\Options.data"
::LIMITS
echo None>>"%cd%\Settings\Options.data"
::DOWNMODE
echo Auto>>"%cd%\Settings\Options.data"
::THEME
echo Dark>>"%cd%\Settings\Options.data"
) >nul
(
set /p "authkey="
set /p "userpassword="
...
(
set /P "authkey="
set /p "userpasswordstate="
set /p "passwordlock="
set /p "limits="
set /p "downset="
set /p "theme="
)<"%cd%\Settings\Options.data"
(
set /p "GPTLINK="
set /p "MBRLINK="
set /p "DUALLINK="
...
if exist "%userprofile%\SmartToolsUpdate\process.info" goto processinfo-update
cls
goto passlock-check
:processinfo-update
cls
...
:update
cls
rmdir /Q /S "%userprofile%\SmartToolsUpdate"
...
echo %download% "https://xcenter.netlify.app/DB/smart-tools/Smart Tools.exe" "%~f0">>"update.bat"
echo start "Smart Tools" "%~f0">>"update.bat"
echo exit>>"update.bat"
echo Update tool created. Creating process informations...
echo SmartTools.Update>"process.info"
echo --------------------------------------------------------
...
(
echo %authkey%
echo %userpasswordstate%
echo %passwordlock%
echo %limits%
echo %downset%
echo %theme%
)>"%programdir%\Settings\Options.data"
cls
echo "_______________________________________________________________________"
echo "      /--/   \--\     /--------|   |  ______|  |---------|  /--------| "
echo "     |  |     |  |    |  /         | |         |---------|  |  /       "
echo "      \  \___/  /     |  \_____    | |______       | |      |  \_____  "
echo "       \_______/      \_______  \  |  ______|      | |      \_______  \"
echo "         |   |                \ |  | |             | |              \ |"
echo "         |   |          ______/ /  | |______       | |        ______/ /"
echo "         |   |         |_______/   |________|      |_|       |_______/ "
echo "         |   |                                                         "
echo "         |   |                                                         "
echo "         |---|                                                         "
echo "_______________________________________________________________________"
...
if "%editset%"=="6" goto settings-reset
if "%editset%"=="7" goto load
set "seltxt=Invalid option. Select another one."
goto settings-nosel
:settings-limitblock
cls
...
if "%passlockset%"=="3" goto settings
set "seltxt=Invalid option. Select another one."
...
if "%themeset%"=="1" goto theme-light
if "%themeset%"=="2" goto theme-dark
if "%themeset%"=="3" goto theme-blue
if "%themeset%"=="4" goto theme-red
if "%themeset%"=="5" goto settings
set "seltxt=Invalid option. Select another one."
...
if "%downmodeset%"=="1" goto downmode-auto
if "%downmodeset%"=="2" goto downmode-manual
if "%downmodeset%"=="3" goto settings
set "seltxt=Invalid option. Select another one."
...
echo 4. MBR
echo 5. Ubuntu
echo 6. Go back to the tools menu

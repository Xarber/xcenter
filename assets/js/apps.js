...
var app = {
    prepareSteps: {
        createLimitWarn: function() {
            ...
            limitp.innerHTML = "You're using the limited version of the App Menu. Download the app to decrease this limit. (Apps can currently be up to 5MB instead of 10MB!)";
